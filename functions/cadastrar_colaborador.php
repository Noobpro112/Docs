...
if(isset($_POST['nome']) && isset($_POST['email']) && isset($_POST['senha']) && isset($_POST['tipo_usuario'])){
    ...
    $StoredPrcedureCadastrar -> bind_param('sssss', $nome, $email, $senha_hash, $tipo, $date); //Passar os parâmetros através do bind_param || primeiro vai o tipo dos valores, no caso 5 strings e depois as variáveis que vão preencher aqueles pontos de interrogação em cima
